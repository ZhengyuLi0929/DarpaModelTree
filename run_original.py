...
def main():
    ...
    #print("rmse:",  error[0])
    #print("ape:", error[1])
    with open('youtube_UIUC_NN_TEXT_top10.json', 'w') as outfile:
        json.dump(yt10, outfile)
    with open('twitter_UIUC_NN_TEXT_top10.json', 'w') as outfile:
        json.dump(tt10, outfile)
    with open('youtube_UIUC_NN_TEXT_top5.json', 'w') as outfile:
        json.dump(yt5, outfile)
    with open('twitter_UIUC_NN_TEXT_top5.json', 'w') as outfile:
        json.dump(tt5, outfile)
    with open('youtube_UIUC_NN_TEXT_avg.json', 'w') as outfile:
        json.dump(yt, outfile)
    with open('twitter_UIUC_NN_TEXT_avg.json', 'w') as outfile:
