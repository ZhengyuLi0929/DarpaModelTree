...
def main():
    ...
    for key in nodelist:
        ...
        for target in targets:
            name = key.replace('/','#')
            fname = name + "_original_221_train.csv"
            ...
            sdate = 1550793600000 # 2-21 #1550188800000# 2-14 #1549584000000
    ...
    #print("rmse:",  error[0])
    #print("ape:", error[1])
    with open('youtube_comp.json', 'w') as outfile:
        json.dump(yt, outfile)
    with open('twitter_comp.json', 'w') as outfile:
...
def plot_model_tree_fit(model, X, y, name,  target, error):
        ...
        #depth = 1
            ...
            data_csv_data_filename = os.path.join(target, name+"_original_221_test.csv")
